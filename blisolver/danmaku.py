...
This is the ONE place in `blisolver` an LLM produces output. The fence is the whole point: mirror,
...
Structured like `blisolver/vision.py`: reuses its `_client(settings)` (OpenAI-compatible LM Studio
