...
# Default whisper.cpp GGML model. Override with HARVEST_WHISPER_MODEL (path to a .bin).
# medium (~1.5 GB) is a good Chinese accuracy/speed tradeoff on M1; small for speed, large-v3 for quality.
WHISPER_MODEL = os.environ.get("HARVEST_WHISPER_MODEL", "/tmp/ggml-medium.bin")
# whisper-cli binary; override with HARVEST_WHISPER_CLI.
WHISPER_CLI = os.environ.get("HARVEST_WHISPER_CLI", shutil.which("whisper-cli") or "whisper-cli")
